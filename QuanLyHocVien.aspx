<%@ Page Title="Quản lý học viên" Language="C#" MasterPageFile="~/LayoutAdmin.Master" AutoEventWireup="true" CodeBehind="QuanLyHocVien.aspx.cs" Inherits="BigSchool.QuanLyHocVien" %>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtMaHocVien" runat="server" CssClass="form-control" placeholder="Mã giảng viên"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <asp:DropDownList runat="server" ID="dlHocVienLoc" Width="98%" CssClass="dropdownselect2"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                        ...
                        <div class="Panel-body" style="overflow: auto; overflow: auto">
                            <asp:GridView ID="GV" runat="server" AutoGenerateColumns="false" OnRowCommand="GV_RowCommand" Width="1820px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MaHocVien" HeaderText="Mã giảng viên" />
